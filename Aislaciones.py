...
CAP = pd.read_excel(r'Y:\Entity\GPI\G_200_Site_Incahuasi\05_PRODUCCION\100_SPV\output.xlsx', sheet_name='CAP')  
CAE = pd.read_excel(r'Y:\Entity\GPI\G_200_Site_Incahuasi\05_PRODUCCION\100_SPV\output.xlsx', sheet_name='CAE') 
